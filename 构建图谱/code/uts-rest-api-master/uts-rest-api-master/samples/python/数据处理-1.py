...
# for i in set(complete_atom_uri_list):
...
# print(len(related_atom_list), flush=True)
...
# # f1 = open("/code/pinkpig/KDD_TX/KDD/构建图谱/data/graph/cuis_1.csv", 'w', newline='')
...
#     if count == 0:
#         count += 1
#         # csv_writer1.writerow(['cui_uri', 'name', 'semantic_type'])
