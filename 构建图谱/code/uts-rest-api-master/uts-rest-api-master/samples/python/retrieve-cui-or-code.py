...
# source = args.source
csv_reader = csv.reader(open(all_path.drug_with_cui_link_file, 'r', encoding='gbk'))
csv_writer = csv.writer(open(all_path.drug_relation_file, "w", encoding="gbk", newline=''))
...
for line in csv_reader:
    if count==0:
        csv_writer.writerow(line+["definitions", "parents", "children", "relations"])
        count+=1
        continue
    identifier = line[6]
