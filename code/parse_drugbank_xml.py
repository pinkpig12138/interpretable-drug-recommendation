...
for child in root:
    ...
    for enzyme in child.find(tag_prefix+'enzymes').findall(tag_prefix+'enzyme'):
        ...
        if enzyme_organism is None and enzyme_taxonomy_id == '9606':
            enzyme_organism = 'Humans'
        if enzyme_organism == 'Humans' and enzyme_taxonomy_id == '':
    ...
    for transporter in child.find(tag_prefix+'transporters').findall(tag_prefix+'transporter'):
        ...
        if transporter_organism is None and transporter_taxonomy_id == '9606':
            transporter_organism = 'Humans'
        if transporter_organism == 'Humans' and transporter_taxonomy_id == '':
...
outf = open('../data/drugbank/drugbank05_drugs.csv', 'w', newline='')
...
outf = open('../data/drugbank/drugbank05_partner_protein.csv', 'w', newline='')
outfh = open('../data/drugbank/drugbank05_partner_protein_human.csv', 'w', newline='')
writer = csv.writer(outf)
...
for partner_id in sorted(target2attrib.keys()):
    ...
    if taxonomy_id == '9606' and organism == 'Humans':
        writerh.writerow([partner_id, partner_name, gene_name, uniprot_id, genbank_gene_id, genbank_protein_id, hgnc_id, organism, taxonomy_id])
    
    if taxonomy_id == '9606' and organism.lower() != 'Humans':
...
# Targets
outf = open('../data/drugbank/drugbank05_drug2target.csv', 'w', newline='')
outfh = open('../data/drugbank/drugbank05_drug2target_human.csv', 'w', newline='')
writer = csv.writer(outf)
writerh = csv.writer(outfh)
...
for drugbank_id in drugs:
    for (target_id, target_actions) in drug2attrib[drugbank_id]['targets']:
        ...
        if target2attrib[target_id]['organism'] == 'Humans' and target2attrib[target_id]['taxonomy_id'] == '9606':
...
# Enzymes
outf = open('../data/drugbank/drugbank05_drug2enzyme.csv', 'w', newline='')
outfh = open('../data/drugbank/drugbank05_drug2enzyme_human.csv', 'w', newline='')
writer = csv.writer(outf)
writerh = csv.writer(outfh)
...
for drugbank_id in drugs:
    for (enzyme_id, enzyme_actions) in drug2attrib[drugbank_id]['enzymes']:
        ...
        if enzyme2attrib[enzyme_id]['organism'] == 'Humans' and enzyme2attrib[enzyme_id]['taxonomy_id'] == '9606':
...
# Transporters
outf = open('../data/drugbank/drugbank05_drug2transporter.csv', 'w', newline='')
outfh = open('../data/drugbank/drugbank05_drug2transporter_human.csv', 'w', newline='')
writer = csv.writer(outf)
writerh = csv.writer(outfh)
...
for drugbank_id in drugs:
    for (transporter_id, transporter_actions) in drug2attrib[drugbank_id]['transporters']:
        ...
        if transporter2attrib[transporter_id]['organism'] == 'Humans' and transporter2attrib[transporter_id]['taxonomy_id'] == '9606':
